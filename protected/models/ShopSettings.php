...
class ShopSettings extends ActiveRecord
{
    ...
    {
        $rules = [
            [['copyrights', 'shop_name', 'shop_code', 'min_order'], 'required'],
            [[
                'header_menu',
                'footer_menu',
                'text',
    ...
    public function beforeSave($insert)
    {
        ...
        $this->upi_details = json_encode($this->upi_details);
    ...
    public function afterFind()
    {
        ...
        if ($this->upi_details) {
            $this->upi_details = json_decode($this->upi_details, true);
        }
        if ($this->banner_ids) {

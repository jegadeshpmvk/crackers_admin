...
<div class="dashboard_header">
    ...
    <div class="dashboard_buttons">
        <?= Html::a('<span>Export Report</span>', ['report/export-excel'], ['class' => 'fa fa-download custom_button', 'target' => '_blank']) ?>
...
<div class="dashboard_grids">
    <div class="dashboard_grid">
        <div class="dashboard_grid_inner">
            <h4 class="grid_title">Total Product <i class="fa fa-tag"></i></h4>
            <div class="grid_amount"><?= $product; ?> <span></span></div>
...
<div class="dashboard_chats">
    <div class="sales_order">
        <div class="dashboard_grid_inner">
            <h4 class="grid_title">Order</h4>
            <div class="" id="lineChart" data-days='<?= Html::encode($days) ?>'
                data-ordercounts='<?= Html::encode($orderCounts) ?>'></div>
        </div>
    </div>
...
<div class="dashboard_chats dashboard_chats_recent_orders">
    <div class="dashboard_grid_inner">
